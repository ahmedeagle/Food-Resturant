...
$(document).ready(function () {
    $("#pcoded").pcodedmenu({
        ...
        ActiveItemBackground: 'theme10', // theme1, theme2, theme3, theme4, theme5, theme6, theme7, theme8, theme9, theme10, theme11, theme12  mennu active item color // theme1, theme2, theme3, theme4, theme5, theme6, theme7, theme8, theme9, theme10, theme11, theme12  mennu active item color
        ...
        layouttype:'dark', // Value should be light / dark
