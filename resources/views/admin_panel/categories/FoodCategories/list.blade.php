...
<div class="page-header card">
   <div class="card-block">
      ...
      <ul class="breadcrumb-title b-t-default p-t-10">
         ...
         <li class="breadcrumb-item"><a href="{{ url('admin/foodCategories') }}" style="line-height: 2.5">{{ $title }}</a>
         </li>
         <a style="float: left; color: white" href="{{ url('admin/foodCategories/add') }}" class="btn btn-grd-primary">اضافة نوع اكل جديد</a>
      </ul>
   </div>
</div>
<div class="page-body">
               ...
               <tbody>
                  @foreach($categories as $key => $category)
                    <tr>
                        ...
                        <td>
                            <a href="{{ url('admin/foodCategories/edit/'.$category->id) }}" class="btn btn-warning ">تعديل</a>
...
<script>
        ...
        a.href = "{{ url('admin/foodCategories/delete') }}"+ "/" +val;
