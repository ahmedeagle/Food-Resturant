...
<div class="page-body">
      ...
      <div class="card">
         ...
         <div class="card-block">
            <form action="{{ url("/admin/foodCategories/store") }}" method="POST">
                {{ csrf_field() }}
               ...
               <button type="submit" class="btn btn-md btn-success"><i class="icofont icofont-check"></i>  اضافة </button>    <a href="{{ url('admin/foodCategories') }}" class="btn btn-md btn-danger"><i class="icofont icofont-close"></i>  رجوع </a>
            </form>
         </div>
</div>
@endsection
