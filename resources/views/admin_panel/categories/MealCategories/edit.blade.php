...
<div class="page-body">
      ...
      <div class="card">
         ...
         <div class="card-block">
            <form action="{{ url("admin/mealCategories/update/" . $categories->id) }}" method="POST">
                {{ csrf_field() }}
              <div class="form-group row">
               ...
               <button type="submit" class="btn btn-md btn-success"><i class="icofont icofont-check"></i>  تعديل </button>    <a href="{{ url('admin/mealCategories') }}" class="btn btn-md btn-danger"><i class="icofont icofont-close"></i>  رجوع </a>
            </form>
         </div>
</div>
@endsection