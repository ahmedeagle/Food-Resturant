      ...
      <div class="card">
         ...
         <div class="card-block">
            <form action="{{ url("/admin/mealCategories/store") }}" method="POST">
               ...
               <button type="submit" class="btn btn-md btn-success"><i class="icofont icofont-check"></i>  اضافة </button>    <a href="{{ url('admin/mealCategories') }}" class="btn btn-md btn-danger"><i class="icofont icofont-close"></i>  رجوع </a>
            </form>
         </div>
</div>
@endsection
