...
<div class="page-header card">
   <div class="card-block">
      ...
      <ul class="breadcrumb-title b-t-default p-t-10">
         ...
         <li class="breadcrumb-item"><a href="{{ url('admin/mainCategories') }}">التصنيفات الرئيسية</a>
         </li>
...
<div class="page-body">
      ...
      <div class="card">
         ...
         <div class="card-block">
            <form action="{{ url("admin/mainCategories/update/" . $categories->id) }}" method="POST">
                {{ csrf_field() }}
              <div class="form-group row">
               ...
               <button type="submit" class="btn btn-md btn-success"><i class="icofont icofont-check"></i>  تعديل </button>    <a href="{{ url('admin/mainCategories') }}" class="btn btn-md btn-danger"><i class="icofont icofont-close"></i>  رجوع </a>
            </form>
         </div>
</div>
@endsection