...
<div class="page-header card">
   <div class="card-block">
      ...
      <ul class="breadcrumb-title b-t-default p-t-10">
         ...
         <li class="breadcrumb-item"><a href="{{ url('admin/mainCategories') }}" style="line-height: 2.5">{{ $title }}</a>
         </li>
         <a style="float: left; color: white" href="{{ url('admin/mainCategories/add') }}" class="btn btn-grd-primary">اضافة تصنيف رئيسى جديد</a>
      </ul>
   </div>
</div>
<div class="page-body">
               ...
               <tbody>
                  @foreach($categories as $key => $category)
                    <tr>
                        ...
                        <td>
                            <a href="{{ url('admin/mainCategories/edit/'.$category->id) }}" class="btn btn-warning ">تعديل</a>
...
<script>
        ...
        a.href = "{{ url('admin/mainCategories/delete') }}"+ "/" +val;
