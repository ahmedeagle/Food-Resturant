...
<div class="page-header card">
   <div class="card-block">
      ...
      <ul class="breadcrumb-title b-t-default p-t-10">
         ...
         <li class="breadcrumb-item"><a href="{{ url('admin/ticketTypes') }}" style="line-height: 2.5"><?=$title?></a>
         </li>
         <a style="float: left; color: white" href="{{ url('admin/ticketTypes/add') }}" class="btn btn-grd-primary">اضافة نوع جديد</a>
      </ul>
   </div>
</div>
<div class="page-body">
               ...
               <tbody>
                  @foreach($tickets_types as $key => $type)
                    <tr>
                        ...
                        <td>
                            <a href="{{ url('admin/ticketTypes/edit/'.$type->id) }}" class="btn btn-warning ">تعديل</a>
...
<script>
        ...
        a.href = "{{ url('admin/ticketTypes/delete/') }}"+ "/" +val;
