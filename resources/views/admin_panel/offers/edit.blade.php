            ...
            <form action="{{ url("admin/offers/update/" . $offers->id) }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="order_level" value="{{ old("order_level", $offers->order_level) }}" placeholder="ترتيب الظهور فى الموقع بإدخال 0 سيكون اقل ترتيب">
