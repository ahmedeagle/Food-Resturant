...
@section('content')
    <div class="page-header card">
        <div class="card-block">
            ...
            <ul class="breadcrumb-title b-t-default p-t-10">
                ...
                <li class="breadcrumb-item"><a href="{{ url('admin/bookingstatus') }}">حالات الحجز</a>
                </li>
    ...
    <div class="page-body">
        ...
        <div class="card">
            ...
            <div class="card-block">
                <form action="{{ url("/admin/bookingstatus/store") }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <button type="submit" class="btn btn-md btn-success"><i class="icofont icofont-check"></i>  اضافة </button>    <a href="{{ url('admin/bookingstatus') }}" class="btn btn-md btn-danger"><i class="icofont icofont-close"></i>  رجوع </a>
                </form>
            </div>
        </div>
@endsection