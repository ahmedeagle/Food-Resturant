                ...
                <div class="col-lg-9 col-md-8 col-12 mt-4 mt-md-0 font-body-bold">
                    ...
                    <span class="orders-address">
                        ...
                        {{$orderDetails -> is_delivery  == 1 ? trans('site.delivery') : trans('site.fromResturant')}}
                            ...
                            <div class="col-xl-3 col-lg-4 col-auto mt-3 mt-lg-0 font-body-md text-lg-center">
                                <span class="py-2 bg-warning text-white d-lg-inline d-block px-3 rounded-curved">
                    ...
                    <div class="py-3 rounded-lg shadow-around my-4">
                             ...
                             <div class="col-xl-7 col-lg-6 col-12 pr-lg-0 d-flex justify-content-center" style=" width: 500px; height: 400px;">
                                <div id="map-user" class="col-xl-7 col-lg-6 col-12 pr-lg-0 d-flex justify-content-center" style=" width: 500px; height: 400px;"></div>
                            </div><!-- .media-body -->
