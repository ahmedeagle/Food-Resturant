            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8 col-12 mt-4 mt-md-0 font-body-bold">
                    <div class="py-2 pr-3 rounded-lg shadow-around">
                        <h4 class="page-title">{{trans('site.change_restaurant_cats')}}</h4>
                    </div>
                    <div class="p-3 rounded-lg shadow-around mt-4">
                        ...
                        @endif
                            ...
                            <form id="register-food-form" action="{{ url("/restaurant/profile/change-resturant-categories") }}" method="POST" class="mt-4 font-body-md " data-toggle="buttons">
                    ...
                    <div class="text-center mt-4 text-center">
                        <button type="submit" id="cat_change"  class="btn btn-primary px-5 mx-auto text-center"> {{trans('site.change')}}</button>
                    </div>
                    </form>
