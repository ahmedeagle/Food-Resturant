            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8 col-12 mt-4 mt-md-0 ">
                            ...
                            <div class="rounded-lg shadow-around bg-white py-2 font-body-md my-3">
                                ...
                                <div class="media align-items-lg-start align-items-center flex-column flex-lg-row">
                                    <img class="rounded-circle mb-lg-0 mb-3 ml-3 mt-2 mr-3"
                                         src="{{ ($reply->FromUser == 1) ?  ($ticket->user_image_url == null) ? url("/storage/app/public/users/avatar.png") : $ticket->user_image_url : url("/assets/site/img/logo.png") }}"
                                         draggable="false"
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h5 class="mt-lg-2 mt-md-0 mt-xs-0 text-lg-right text-center font-size-base">
                                            @if($reply->FromUser == "1") {{ $ticket->user_name }} @else {{ trans("site.support-name") }} @endif
                                        </h5>
                    ...
                    <div class="p-3 rounded-lg shadow-around bg-white py-2 font-body-bold my-3">
                        <form id="add-reply-form" data-action="{{ url("/user/tickets/ticket/add-reply") }}" class="edit-form">
                            <div class="form-group">
                                <label for="provider-details">إضافة رد</label>
                                <input type="hidden" name="ticket_id" class="ticket_id" value="{{ $ticket->ticket_id }}" />
