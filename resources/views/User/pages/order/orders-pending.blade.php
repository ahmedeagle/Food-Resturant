        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8 col-12 mt-4 mt-md-0 font-body-bold">
                        ...
                        <div class="row px-3 px-lg-0">
                            <div class="col-lg-8 col-12 pr-lg-0 mx-auto">
                                <div class="order-confirm text-center text-sm-right">
                                    <a href="{{ url("/user/orders/decline-order/" . $orderDetails->order_id) }}" class="btn btn-primary px-xl-5 px-md-3 px-sm-5 px-5 ml-0 mt-2 ml-sm-2"
                                            >
                    ...
                    <a href="{{ url("/user/orders") }}" class="btn btn-primary px-5"> {{trans('site.back')}}</a>
