    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-12 mt-4 mt-md-0 font-body-bold">
                    ...
                    <div class="media align-items-center flex-column flex-lg-row">
                        ...
                        <div class="media-body">
                            ...
                            <div class="reservation-confirm mt-1 text-center text-sm-right">
                                ...
                                <a href="{{ url("/user/reservations/decline/". $reservationDetails->reservation_id) }}" class="btn btn-primary px-xl-5 px-md-3 px-sm-5 px-5 ml-0 mt-2 ml-sm-2"
                                        >
                                    إلغاء الحجز
                                </a>
                ...
                <a href="{{ url("/user/reservations") }}" class="btn btn-primary px-5">العودة</a>
