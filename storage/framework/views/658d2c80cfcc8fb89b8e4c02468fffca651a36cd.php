...
<div class="page-header card">
   <div class="card-block">
      ...
      <ul class="breadcrumb-title b-t-default p-t-10">
         ...
         <li class="breadcrumb-item"><a href="<?php echo e(url('admin/foodCategories')); ?>" style="line-height: 2.5"><?php echo e($title); ?></a>
         </li>
         <a style="float: left; color: white" href="<?php echo e(url('admin/foodCategories/add')); ?>" class="btn btn-grd-primary">اضافة نوع اكل جديد</a>
      </ul>
   </div>
</div>
<div class="page-body">
               ...
               <tbody>
                  <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(url('admin/foodCategories/edit/'.$category->id)); ?>" class="btn btn-warning ">تعديل</a>
...
<script>
        ...
        a.href = "<?php echo e(url('admin/foodCategories/delete')); ?>"+ "/" +val;
