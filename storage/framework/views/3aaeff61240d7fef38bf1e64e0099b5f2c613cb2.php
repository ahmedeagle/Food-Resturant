...
<?php $__env->startSection('content'); ?>
        ...
        <div class="container">
            <div class="row">
                ...
                <?php endif; ?>
                <div class="<?php if(auth()->user()): ?> col-lg-9 col-md-8 col-12 <?php else: ?> col-lg-12 col-md-11 col-12 <?php endif; ?> mt-4 mt-md-0 ">
                            ...
                            <tbody>
                              <tr>
                                ...
                                <?php if($meal->vegetable == "1"): ?>
                                   <span class="" title="الوجبة نباتية"><img src="<?php echo e(url('/')); ?>/storage/app/public/icons/vegetarian-meals-icon.png"/></span>
                                <?php endif; ?>
                                
                                <?php if($meal->calories): ?>
                                   <span class="" title="<?php echo e($meal->calories); ?> سعره حرارية"><img src="<?php echo e(url('/')); ?>/storage/app/public/icons/no-gluten-icon.png"/></span>
                                <?php endif; ?>   
                                </td>
                        ...
                        <table class="table mb-0 tebel-meal">
                            <thead>
                              <tr class="">
                                ...
                                <th scope="col" class="border-top-0 text-primary font-body-md"><?php echo e($meal->calories); ?> سعره حرارية</th>
                              ...
                              <tr>
                                  ...
                                  <th scope="col" class="border-top-0 text-primary font-body-md"><?php echo e(( $meal->recommend == "1") ? 'نعم' : 'لا'); ?></th>
                                  <th></th>
                              </tr>
                              ...
                              <tr>
                                ...
                                <td class="text-primary font-body-md ">
                                    ...
                                    <?php $__currentLoopData = $meal->adds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $add): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="mb-2">
                                            <?php echo e($add->added_price); ?> ر.س
                                        </div> 
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </td>
                                <?php else: ?>
                              ...
                              <th scope="row" class="font-body-md">التفضيلات</th>
                                ...
                                <td class="text-primary font-body-md ">
                                    ...
                                    <?php $__currentLoopData = $meal->options; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $options): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="mb-2">
                                            <?php echo e($options->added_price); ?> ر.س
                                        </div> 
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </td>
                                <?php else: ?>
                    ...
                    <?php if(auth()->user() && $meal->accept_order == "1"): ?>
                    ...
                    <?php if($clearing_cart_content_warning == 1): ?>
                        ...
                        <div class="alert alert-warning">
                            ...
                            <a style="color: blue;text-decoration: underline" href="<?php echo e(url("/user/cart")); ?>">تصفح محتويات السلة</a>
                        </div>
