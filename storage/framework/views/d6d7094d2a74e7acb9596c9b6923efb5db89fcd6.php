...
<?php $__env->startSection('content'); ?>
    <div class="page-header card">
        <div class="card-block">
            ...
            <ul class="breadcrumb-title b-t-default p-t-10">
                ...
                <li class="breadcrumb-item"><a href="<?php echo e(url('admin/bookingstatus')); ?>" style="line-height: 2.5"><?=$title?></a>
                </li>
                    ...
                    <table id="order-table" class="table table-striped table-bordered nowrap">
                        ...
                        <?php $__currentLoopData = $tickets_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(url('admin/bookingstatus/edit/'.$type->id)); ?>" class="btn btn-warning ">تعديل</a>
    ...
    <script>
        function deletefn(val){
            ...
            a.href = "<?php echo e(url('admin/bookingstatus/delete/')); ?>"+ "/" +val;
