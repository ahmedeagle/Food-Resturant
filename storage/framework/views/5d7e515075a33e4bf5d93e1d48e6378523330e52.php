    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-12 mt-4 mt-md-0 font-body-bold">
                    ...
                    <div class="media align-items-center flex-column flex-lg-row">
                        ...
                        <div class="media-body">
                            ...
                            <div class="reservation-confirm mt-1 text-center text-sm-right">
                                <a href="<?php echo e(url("/restaurant/reservations/decline/". $reservationDetails->reservation_id)); ?>" class="btn btn-primary px-xl-5 px-md-3 px-sm-5 px-5 ml-0 mt-2 ml-sm-2"
                                        >
                                    <?php echo e(trans('site.cancel_reservation')); ?>

                                </a>
                                <a href="<?php echo e(url("/restaurant/reservations/accept/". $reservationDetails->reservation_id)); ?>" class="btn btn-primary px-xl-5 px-md-3 px-sm-5 px-5 mt-2"
                                        >
                                      <?php echo e(trans('site.confirm_reservation')); ?>

                                </a>
                            </div>
                        </div><!-- .media-body -->
                        <span class="py-2 bg-pending text-white mt-3 mt-lg-0 text-white font-body-md px-3 rounded-curved">
                ...
                <a href="<?php echo e(url("/restaurant/reservations/list/1")); ?>" class="btn btn-primary px-5">  <?php echo e(trans('site.back')); ?></a>
