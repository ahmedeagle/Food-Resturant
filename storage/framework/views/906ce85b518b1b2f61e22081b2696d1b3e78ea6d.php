<div class="search position-relative">
    ...
    <div class="container">
        <div class="py-3 py-md-4 py-lg-5">
            <form method = "POST" action="<?php echo e(url("/search")); ?>" class="search-form py-3 py-md-4 py-lg-5">
                ...
                <div class="form-group py-3 py-md-4 py-lg-5">
                    <label for="search-field"
                         ...
                         <?php echo e(trans('site.search_for_resturant_to_try')); ?>
                    ...
                    <div class="row">
                        <div class="col-xl-7 col-lg-9 col-md-11 col-sm-12 col-12 mx-auto">
                            <div class="input-group shadow-around rounded">
                                <input type="search"
                                       ...
                                       placeholder="<?php echo e(trans('site.search_for_resturant')); ?>"
                                       aria-label="<?php echo e(trans('site.search_for_resturant')); ?>"
                                       name = "query"
                     ...
                     <?php if(Session::has('empty-query')): ?>
                        <div class="row">
                        <div class="col-xl-7 col-lg-9 col-md-11 col-sm-12 col-12 mx-auto">
                        <?php echo e(Session::get('empty-query')); ?>
