...
<div class="page-header card">
   <div class="card-block">
      ...
      <ul class="breadcrumb-title b-t-default p-t-10">
         ...
         <li class="breadcrumb-item"><a href="<?php echo e(url("/admin/cities")); ?>" style="line-height: 2.5"><?php echo e($title); ?></a>
         </li>
         <a style="float: left; color: white" href="<?php echo e(url("/admin/cities/add")); ?>" class="btn btn-grd-primary">اضافة مدينة جديده</a>
      </ul>
   </div>
</div>
<div class="page-body">
               ...
               <tbody>
                  ...
                  <?php $__currentLoopData = $cities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $city): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td><?php echo e($city->ar_name); ?></td>
                        <td><?php echo e($city->en_name); ?></td>
                        <td><?php echo e($city->country_name); ?></td>
                        <td><?php echo e(( $city->active == "1") ? 'مفعل' : 'غير مفعل'); ?></td>
                        <td><?php echo e($city->created_at); ?></td>
                        <td>
                            <a href="<?php echo e(url('admin/cities/edit/'.$city->id)); ?>" class="btn btn-warning ">تعديل</a>
...
<script>
        ...
        a.href = "<?php echo e(url('admin/cities/delete')); ?>" + "/" +val;
