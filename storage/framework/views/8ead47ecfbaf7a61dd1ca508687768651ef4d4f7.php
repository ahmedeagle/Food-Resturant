        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8 col-12 mt-4 mt-md-0 ">
                    ...
                    <form action="<?php echo e(url("/user/tickets/open-new-ticket")); ?>" method="POST">
                    ...
                    <div class="p-3 rounded-lg shadow-around font-body-bold mt-4 bg-white">
                            ...
                            <div class="form-group my-2">
                                ...
                                <select class="custom-select text-gray font-body-md border-gray"
                                        id="messaging-type"
                                        name="type">
                                    <option selected value="يرجى تحديد نوع المراسلة"><?php echo e(trans('site.choose_conversation_type')); ?></option>
