                            ...
                            <div class="col-lg-8 col-12 pr-lg-0 mx-auto">
                                ...
                                <div class="invoice d-flex justify-content-between mt-3">
                                    ...
                                    <div class="result text-primary font-body-md">
                                        ...
                                        <span class="currency"><?php echo e(trans('site.tax')); ?></span>
                                    </div>
                                </div>
                        ...
                        <div class="row px-3 px-lg-0">
                            <div class="col-lg-8 col-12 pr-lg-0 mx-auto">
                                <div class="order-confirm text-center text-sm-right">
                                    <a href="<?php echo e(url("/restaurant/orders/confirm-processed-order/" . $orderDetails->order_id)); ?>" class="btn btn-primary px-xl-5 px-md-3 px-sm-5 px-5 mt-2"
                                    >
                                        <?php echo e(trans('site.order_ready')); ?>
