    ...
    <main class="main-content page-content py-5">
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8 col-12 mt-4 mt-md-0">
                    ...
                    <div class="py-2 pr-3 rounded-lg shadow-around">
                        <h4 class="page-title font-body-bold"> <?php echo e(trans('site.edit_branch')); ?></h4>
                    </div>
                                ...
                                <form data-action="<?php echo e(url('/restaurant/branches/edit')); ?>" id="edit-branch-from" class="new-branch-form multi-forms p-3 font-body-bold">
                                        ...
                                        <select class="custom-select text-gray font-body-md" name="service-provider" id="service-provider" required>
                                          ...
                                          <?php  $name = LaravelLocalization::getCurrentLocale()."_name"?>
                                            <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($cat->id); ?>" <?php if($branch->category_id == $cat->id): ?> selected <?php endif; ?>><?php echo e($cat-> $name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                           <?php endif; ?> 
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select text-gray font-body-md border-gray"
                                            ...
                                            <option value="0" <?php if($branch->booking_status == "0"): ?> selected <?php endif; ?>><?php echo e(trans('site.persons')); ?></option>
                                            <option value="1" <?php if($branch->booking_status == "1"): ?> selected <?php endif; ?>><?php echo e(trans('site.famlies')); ?></option>
                                            <option value="2" <?php if($branch->booking_status == "2"): ?> selected <?php endif; ?>><?php echo e(trans('site.person_family')); ?></option>
                                        </select>
                                        ...
                                        <div class="d-flex justify-content-center flex-column flex-sm-row">
                                          ...
                                          <?php $address = LaravelLocalization::getCurrentLocale().'_address' ?>
                                            <input type="text"
                                                   ...
                                                   id="address-map" value="<?php echo e($branch-> $address); ?>" disabled>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        <label for="phone-number">
                                             <?php echo e(trans('site.password')); ?>
                                        ...
                                        <input type="text"
                                               class="form-control border-gray"
                                               id="password" name="password" placeholder="<?php echo e(trans('site.password')); ?>"  >
                                    ...
                                    <button type="submit" class="btn btn-primary py-2 px-5"> <?php echo e(trans('site.edit')); ?> </button>
                                </form><!-- .new-kind-form -->
                            </div><!-- .tab-pane -->
        ...
        <?php endif; ?>
                                ...
                                <form class="work-times">
                                    ...
                                    <button  type="submit" class="btn btn-primary py-2 px-5 submit_edit_form"> <?php echo e(trans('site.edit')); ?> </button>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-sm-10 col-12 mx-auto font-body-bold mb-5 text-center">
                    ...
                    <Button type="button" id="confirm-branch-location" class="btn btn-primary px-5 no-decoration"><?php echo e(trans('site.confirm')); ?></Button>
