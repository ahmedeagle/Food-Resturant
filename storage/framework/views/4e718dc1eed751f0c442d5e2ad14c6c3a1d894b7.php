...
<div class="page-header card">
   <div class="card-block">
      ...
      <ul class="breadcrumb-title b-t-default p-t-10">
         ...
         <li class="breadcrumb-item"><a href="<?php echo e(url('/admin/countries')); ?>" style="line-height: 2.5"><?=$title?></a>
         </li>
         <a style="float: left; color: white" href="<?php echo e(url('/admin/countries/add')); ?>" class="btn btn-grd-primary">اضافة دولة جديده</a>
      </ul>
   </div>
</div>
<div class="page-body">
               ...
               <tbody>
                  <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                          ...
                          <td><?php echo e($value->ar_name); ?></td>
                          <td><?php echo e($value->en_name); ?></td>
                          <td><?php echo e($value->country_code); ?></td>
                          <td><?php echo e(( $value->active == "1") ? 'مفعل' : 'غير مفعل'); ?></td>
                          <td><?php echo e($value->created_at); ?></td>
                          <td>
                              <a href="<?php echo e(url("/admin/countries/edit/" . $value->id)); ?>" class="btn btn-warning ">تعديل</a>
...
<script>
        ...
        a.href = "<?php echo e(url('/admin/countries/delete')); ?>" + "/" +val;
