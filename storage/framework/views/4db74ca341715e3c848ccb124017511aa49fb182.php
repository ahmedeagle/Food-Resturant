...
<div class="page-header card">
   <div class="card-block">
      ...
      <ul class="breadcrumb-title b-t-default p-t-10">
         ...
         <li class="breadcrumb-item"><a href="<?php echo e(url('admin/ticketTypes')); ?>" style="line-height: 2.5"><?=$title?></a>
         </li>
         <a style="float: left; color: white" href="<?php echo e(url('admin/ticketTypes/add')); ?>" class="btn btn-grd-primary">اضافة نوع جديد</a>
      </ul>
   </div>
</div>
<div class="page-body">
         ...
         <div class="dt-responsive table-responsive">
            <table id="order-table" class="table table-striped table-bordered nowrap">
               <thead>
                  <tr>
                     <th>مسلسل</th>  
                     <th>اسم النوع باللغة العربية</th>
                     <th>اسم النوع باللغة الانجليزية</th>
                     <th>تاريخ الانشاء</th>
                     <th>العمليات</th>
                  </tr>
               </thead>
               <tbody>
                  <?php $__currentLoopData = $tickets_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(url('admin/ticketTypes/edit/'.$type->id)); ?>" class="btn btn-warning ">تعديل</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">حذف النوع</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <p>هل تريد حذف هذا النوع؟</p>
            </div>
...
<script>
        ...
        a.href = "<?php echo e(url('admin/ticketTypes/delete/')); ?>"+ "/" +val;
