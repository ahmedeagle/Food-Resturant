...
<?php $__env->startSection('content'); ?>
    ...
    <main class="page-content py-5">
        ...
        <header class="page-header mt-4 text-center">
            <h1 class="page-title h2 font-body-bold"><?php echo e(trans('site.register')); ?></h1>
        </header>
        <div class="container">
            <div class="row">
                            ...
                            <form action="<?php echo e(url('/user/register')); ?>" method="POST" class="register-form mt-5">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="custom-select text-gray font-body-md" name="user-gender" id="user-sax" required>
                                        ...
                                        <option value="1" <?php if(old('user-gender') == 1): ?> selected <?php endif; ?>><?php echo e(trans('site.male')); ?></option>
                                        <option value="2" <?php if(old('user-gender') == 2): ?> selected <?php endif; ?>><?php echo e(trans('site.female')); ?></option>
                                    </select>
                                ...
                                <div class="form-group">
                                    <label for="phone-number"><?php echo e(trans('site.birth_date')); ?></label>
                                ...
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox pl-0 pr-4 text-gray">
                                        ...
                                        <label class="custom-control-label font-body-md"
                                               for="customCheck6">
                                            <?php echo e(trans('site.you_approved_on')); ?><a href="<?php echo e(url('/page/1')); ?>" class="no-decoration text-primary"><?php echo e(trans('site.usage')); ?></a>
                                        </label>
                                ...
                                <button type="submit" class="btn btn-primary py-2 px-5"><?php echo e(trans('site.register')); ?></button>
                            </form><!-- .register-form -->
                            ...
                            <form id="provider-register-form" class="register-form mt-4" data-action="<?php echo e(url('/restaurant/register')); ?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file h-auto">
                                        ...
                                        <?php echo e(trans('site.add_restaurant_logo')); ?>

                                            </span>
                                            <p id="provider-logo-error" class="alert alert-danger hidden-element top-margin logo-error"><?php echo e(trans('site.add_restaurant_logo')); ?></p>
                                        </label>
                                    </div>
                                </div><!-- .form-group logo -->

                                <div class="form-group">
                                    <label for="restaurant-ar-name"><?php echo e(trans('site.res_name_ar')); ?></label>
                                    <input type="text"
                                           class="form-control border-gray font-body-md"
                                ...
                                <div class="form-group">
                                    <label for="restaurant-en-name"><?php echo e(trans('site.res_name_en')); ?></label>
                                    <input type="text"
                                           class="form-control border-gray font-body-md"
                                ...
                                <div class="form-group">
                                    <label for="provider-ar-details"><?php echo e(trans('site.abbrev_services_ar')); ?></label>
                                ...
                                <div class="form-group">
                                    <label for="provider-en-details"><?php echo e(trans('site.abbrev_services_en')); ?></label>
                                    <textarea class="form-control font-body-md"
