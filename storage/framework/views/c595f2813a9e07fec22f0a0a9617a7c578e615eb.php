            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8 col-12 mt-4 mt-md-0 ">
                    ...
                    <div class="py-2 pr-3 rounded-lg shadow-around bg-white">
                        <h4 class="page-title font-body-bold"><?php echo e(trans('site.my_previous_tickets')); ?></h4>
                    </div>
                    ...
                    <div class="rounded-lg shadow-around mt-3 overflow-hidden">
                        ...
                        <div class="table-responsive bg-white">
                            ...
                            <table class="table table-striped">
                                ...
                                <tr>
                                    <th scope="col-7"><?php echo e(trans('site.subject')); ?></th>
                                    <th scope="col-4"><?php echo e(trans('site.date')); ?></th>
                                </tr>
                                ...
                                <?php $__currentLoopData = $tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ticket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <th scope="row" class="font-body-md text-nowrap "><a href="<?php echo e(url('/user/tickets/ticket/details/'. $ticket->id)); ?>"><?php echo e($ticket->title); ?></a></th>
                    ...
                    <?php else: ?>
                        <div class="mt-4"> <?php echo e(trans('site.tickets_list_empty')); ?></th></div>
                    <?php endif; ?>
