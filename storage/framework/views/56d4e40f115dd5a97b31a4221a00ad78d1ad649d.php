    ...
    <main class="page-content py-5">
        <div class="container">
            <div class="row">
                ...
                <div class="<?php if(auth('web')->check()): ?> col-lg-9 col-md-8 <?php else: ?> col-lg-12 col-md-11 <?php endif; ?> col-12 mt-4 mt-md-0 ">
                    ...
                    <div class="row">
                        ...
                        <?php else: ?>
                            ...
                            <p class="mt-4"><?php echo e(trans('site.food_list_empty')); ?></p>
