            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8 col-12 mt-4 mt-md-0 font-body-bold">
                    <div class="py-2 pr-3 rounded-lg shadow-around bg-white">
                        <h4 class="page-title font-body-bold"><?php echo e(trans('site.the_order')); ?></h4>
                    </div>
                    ...
                    <div class="py-4 rounded-lg shadow-around my-4 bg-white">
                        ...
                        <div class="text-center ">
                            ...
                            <p class="font-body-md">
                                 <?php echo e(trans('site.order_send_successfully')); ?>
                    ...
                    <a href="<?php echo e(url("/user/dashboard")); ?>" class="btn btn-primary px-5"><?php echo e(trans('site.back')); ?></a>
