        ...
        <nav class="navbar navbar-expand-lg font-body-bold px-0">
            ...
            <div class="collapse navbar-collapse justify-content-end col-lg-9 col-md px-1" id="top-navigation">
                ...
                <div class="input-group input-group-sm mb-0 justify-content-end align-items-center flex-lg-row">
                    <input type="search" form="user-search-form" name="query" class="form-control border-gray font-body-md text-gray d-sm-inline-flex" placeholder="<?php echo e(trans('site.search_for')); ?>" aria-label="" aria-describedby="basic-addon1" required>
                    <div class="input-group-prepend d-inline d-sm-inline-flex">
                        <button form="user-search-form" class="btn btn-primary py-1 px-4" type="submit"><?php echo e(trans('site.search')); ?></button>
                    </div>
                </div>
                ...
                <div class="client-area mt-lg-0 mt-md-2 mt-sm-0 d-flex justify-content-center flex-column flex-lg-row align-items-center">
                    ...
                    <a class="d-inline-flex m-2 mr-md-3 ml-sm-0">
                        ...
                        height="25">
                        <h2 class="font-size-base font-body-md ml-2 mb-1 wallet"><?php echo e(\App\Http\Controllers\User\BalanceController::get_balance()); ?> <?php echo e(trans('site.riyal')); ?></h2>
                    </a>
