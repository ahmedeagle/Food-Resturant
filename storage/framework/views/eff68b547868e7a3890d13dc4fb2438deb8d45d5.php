...
<?php $__env->startSection('content'); ?>
    ...
    <main class="page-content py-5">
        ...
        <header class="page-header mt-4 text-center">
            <h1 class="page-title h2 font-body-bold">أهلا وسهلا بك في تطبيق مجرّب</h1>
            <p class="description text-gray font-body-md mt-3">يرجى تحديد نوع الطعام الذي تقدمة</p>
        </header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-sm-10 col-12 mx-auto font-body-bold mb-5 text-center">
                    ...
                    <form id="register-food-form" action="<?php echo e(url("/restaurant/complete-profile/food")); ?>" method="POST" class="mt-4 font-body-md " data-toggle="buttons">
