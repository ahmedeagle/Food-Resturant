            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8 col-12 mt-4 mt-md-0 font-body-bold">
                        ...
                        <div class="media align-items-lg-start align-items-center flex-column flex-lg-row">
                            ...
                            <div class="media-body">
                                ...
                                <p class="mt-lg-1 mt-md-0 mt-xs-0 mb-lg-0 text-lg-right text-center font-body-md font-size-base">
                                    الإضافات:
                                    <span class="text-gray"><?php echo e($item['addsNameString']); ?> ( السعر المضاف : <?php echo e($item['addsAddedPrice']); ?> ر.س)</span>
                                </p>

                                <p class="mt-lg-1 mt-md-0 mt-xs-0 mb-lg-0 text-lg-right text-center font-body-md font-size-base">
                                    التفضيلات:
                                    <span class="text-gray"><?php echo e($item['optionsNameString']); ?>   ( السعر المضاف : <?php echo e($item['optionsAddedPrice']); ?> ر.س)</span>
                                </p>

                            </div><!-- .media-body -->

                            <a href="<?php echo e(url("/user/cart/remove-cart-meal/" . $key)); ?>" class="cancel-btn py-1 px-4 mt-lg-4 no-bg border border-primary d-lg-inline d-block rounded text-primary font-body-md ml-lg-3">إلغاء</a>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <a href="<?php echo e(url("/user/cart/complete-order")); ?>" class="btn btn-primary px-5">التالي</a>
                    <?php else: ?>
