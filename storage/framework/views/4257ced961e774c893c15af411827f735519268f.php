            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-8 col-12 mt-4 mt-md-0 font-body-bold">
                    <div class="py-2 pr-3 rounded-lg shadow-around">
                        <h4 class="page-title"><?php echo e(trans('site.change_food_type')); ?></h4>
                    </div>
                    <div class="p-3 rounded-lg shadow-around mt-4">
                        ...
                        <?php endif; ?>
                            ...
                            <form id="register-food-form" action="<?php echo e(url("/restaurant/profile/change-meal-type")); ?>" method="POST" class="mt-4 font-body-md " data-toggle="buttons">
                    ...
                    <div class="text-center mt-4 text-center">
                        <button type="submit" id="register-food-btn" class="btn btn-primary px-5 mx-auto text-center"><?php echo e(trans('site.change')); ?></button>
                    </div>
                    </form>
