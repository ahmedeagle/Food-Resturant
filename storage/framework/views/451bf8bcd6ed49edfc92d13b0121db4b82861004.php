                        ...
                        <div class="row px-3 px-lg-0">
                            <div class="col-lg-8 col-12 pr-lg-0 mx-auto">
                                <div class="order-confirm text-center text-sm-right">
                                    <a href="<?php echo e(url("/restaurant/orders/decline-order/" . $orderDetails->order_id)); ?>" class="btn btn-primary px-xl-5 px-md-3 px-sm-5 px-5 ml-0 mt-2 ml-sm-2"
                                            >
                                          <?php echo e(trans('site.cancel_order')); ?>

                                    </a>
                                    <a href="<?php echo e(url("/restaurant/orders/accept-order/" . $orderDetails->order_id)); ?>" class="btn btn-primary px-xl-5 px-md-3 px-sm-5 px-5 mt-2"
                                            >
                                         <?php echo e(trans('site.confirm_order')); ?>
