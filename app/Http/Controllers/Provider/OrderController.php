    ...
    public function processed_order($id)
    {
        ...
        DB::table("notifications")
            ->insert([
                "en_title" => "change order status",
                "ar_title" => $push_notif_title,
                "en_content" => "The Service Provider by " . $desc_en . "process the Order With Code {$user->code}, Login To You Account to See More Details",
                "ar_content" => $post_title,
                "notification_type" => 1,
                "actor_id" => $user->user_id,
                "actor_type" => "user",
...
//        App()->setLocale("ar");
        ...
        DB::table("notifications")
            ->insert([
                ...
                "ar_title" => $push_notif_title,
                "en_content" => "The Service Provider by " . $desc_en . " Finish the Order With Code {$user->code}, Please Rate the Restaurant To Help Us Provider Excellent Service",
                "ar_content" => $post_title,
                "notification_type" => 3,
                "actor_id" => $user->user_id,
                "actor_type" => "user",
