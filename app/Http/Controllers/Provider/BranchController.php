...
class BranchController extends Controller
{
    ...
    public function post_add_branch(Request $request)
    {
        ...
        $en_address = (new GeneralController())->get_address_from_location($request->lat, $request->lng, 'en');
        $ar_address = (new GeneralController())->get_address_from_location($request->lat, $request->lng, 'ar');
        $data = [
